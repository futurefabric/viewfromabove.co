class HomeController < ApplicationController
  ...
  def index
    ...
    twitter_hadfield_since_id = "300000000000000000"
    twitter_hadfield_max_id = "334011022815944705"

    twitter_nyberg_since_id = "339350311237976064"
    twitter_nyberg_max_id = "999999999999999999"
    ...
    if params[:max_id] != nil
      ...
      # last of AstroKarenN’s tweets we want
      if tweet_max_id < "341299897074581506"
        twitter_hadfield_max_id = tweet_max_id
      else
        twitter_nyberg_max_id = tweet_max_id
      end
